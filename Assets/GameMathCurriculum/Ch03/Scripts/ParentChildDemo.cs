...
public class ParentChildDemo : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Matrix4x4 paraentMatrix=Matrix4x4.TRS(transform.position,transform.rotation,transform.localScale);

        childLocalPos = paraentMatrix.MultiplyPoint(childLocalPos);
